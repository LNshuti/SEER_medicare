...
data outpat_small;
	set outpat(keep = patient_id claim_id state_cd ms_cd from_dtm from_dtd from_dty pmt_amt tot_chrg charge tot_line seg_line tot_seg seg_num rec_count year dgn_cd1--dgn_cd13 prcdr_cd1--prcdr_cd13 prcdrdtm1--prcdrdtm13 prcdrdtd1--prcdrdtd13 prcdrdty1--prcdrdty13);
run;
...
LIBNAME SDF "&sasdir";
PROC EXPORT DATA=outpat_smaller
			FILE="dta_exports\&filein"
			DBMS=STATA REPLACE;
run;
