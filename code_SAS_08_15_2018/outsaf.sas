...
/* proc import datafile = 'C:\QSU\SEER\data_in\patient_ids.csv'     This didn't work!
out=patient_ids dbms=excel replace;
dbdsopts = "DBTYPE=(patient_id='CHAR(11)')";  
run;  */ 
...
data file_list_outpat;
	set file_list(where = (fname contains 'outsaf'));
run;
...
/* this is one of 700 files, says EC 6/7/2018*/
filename outin "S:/Raw files unzipped/&filein";                    /* reading in an un-zipped file */
...
data outpat_small;
	set outpat(keep = patient_id claim_id state_cd ms_cd from_dtm from_dtd from_dty pmt_amt tot_chrg charge tot_line seg_line tot_seg seg_num rec_count year hcpcs mf1 mf2 mf3 dgn_cd1--dgn_cd13 prcdr_cd1--prcdr_cd13 prcdrdtm1--prcdrdtm13 prcdrdtd1--prcdrdtd13 prcdrdty1--prcdrdty13);
run;


/* keep only claims that are for certain daignosis or procedure codes*/
/* hmmm... but Summer wants the HCPCS codes, not procedure codes
data outpat_smaller;
    set outpat_small(where = (prcdr_cd1 in( '8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241' ) or
    prcdr_cd2 in( '8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241' ) or
    prcdr_cd3 in( '8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241' ) or
    prcdr_cd4 in( '8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241' ) or
    prcdr_cd5 in( '8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241' ) or
    prcdr_cd6 in( '8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241' ) or
    prcdr_cd7 in( '8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241' ) or
    prcdr_cd8 in( '8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241' ) or
    prcdr_cd9 in( '8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241' ) or
    prcdr_cd10 in('8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241'  ) or
    prcdr_cd11 in('8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241'  ) or
    prcdr_cd12 in('8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241'  ) or
    prcdr_cd13 in('8701', '8702', '8703', '8704', '8705', '8706', '8707', '8708', '8709', '8711', '8712', '8713', '8714', '8715', '8716', '8717', '8721', '8722', '8723', '8724', '8729', '8731', '8732', '8733', '8734', '8735', '8736', '8737', '8738', '8739', '8741', '8742', '8743', '8744', '8749', '8751', '8752', '8753', '8754', '8759', '8761', '8762', '8763', '8764', '8765', '8766', '8769', '8771', '8772', '8773', '8774', '8775', '8776', '8777', '8778', '8779', '8781', '8782', '8783', '8784', '8785', '8789', '8791', '8792', '8793', '8794', '8795', '8799', '8801', '8802', '8803', '8804', '8809', '8811', '8812', '8813', '8814', '8815', '8816', '8819', '8821', '8822', '8823', '8824', '8825', '8826', '8827', '8828', '8829', '8831', '8832', '8833', '8834', '8835', '8836', '8837', '8838', '8839', '8840', '8841', '8842', '8843', '8844', '8845', '8846', '8847', '8848', '8849', '8850', '8851', '8852', '8853', '8854', '8855', '8856', '8857', '8858', '8859', '8860', '8861', '8862', '8863', '8864', '8865', '8866', '8867', '8868', '8871', '8872', '8873', '8874', '8875', '8876', '8877', '8878', '8879', '8881', '8882', '8883', '8884', '8885', '8886', '8889', '8890', '8891', '8892', '8893', '8894', '8895', '8896', '8897', '8898', '9201', '9202', '9203', '9204', '9205', '9209', '9211', '9212', '9213', '9214', '9215', '9216', '9217', '9218', '9219', '9220', '9221', '9222', '9223', '9224', '9225', '9226', '9227', '9228', '9229', '9230', '9231', '9232', '9233', '9239', '9241'  ) ));
run; */
...
data outpat_smaller; 
	...
	set outpat_small(where = (hcpcs not in(''))); /* select all non-empty HCPCS ... omg*/ 
run;

/* merge in the patient IDs and keep only those that merge */ 
/* Vicki showed me this code ... */ 
data outpat_smaller_ptid;
	MERGE outpat_smaller patient_ids;            /*merge outpat_smaller to patient_ids */
		  BY Patient_ID;                         /* this is the key, but char/numeric */
run;

/* now keep only if indicator */
data outpat_smaller_ptid_ind;
	set outpat_smaller_ptid(where = (indicator in (1)));
run;

/* Eric added this code to saveout to Stata file*/ 
LIBNAME SDF "&sasdir";
PROC EXPORT DATA=outpat_smaller_ptid_ind
