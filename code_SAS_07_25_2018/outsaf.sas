...
proc import datafile = 'C:\Users\echow\QSU\SEER\data_in\patient_ids.csv'
out = patient_ids 
dbms = CSV;
run;
...
/* Vicky showed me this code ... */ 
data outpat_smaller_ptid;
	MERGE outpat_smaller (in=patid)
		  patient_ids;
		  BY patid;
		  IF patid;
run;
...
LIBNAME SDF "&sasdir";
PROC EXPORT DATA=outpat_smaller_ptid
			FILE= "E:\&filein"  /* "dta_exports\&filein" */
			DBMS=STATA REPLACE;
run;
